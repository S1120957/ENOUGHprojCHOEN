...
contract NFA {
	...
	string[] states = ['iuthchrb', 'wanqjqmz', 'tkmnmmzm', 'mvjkbxnf', 'xvmyrzmi', 'lgslqkpt', 'xogzupwz', 'acxbqwvk', 'fnmguihl', 'akvbnhcq', 'pifktqjr'];
	string[] tmpStates;
	string initialState = "iuthchrb";
	string[] finalStates = ['pifktqjr'];
	...
	constructor() public {
		transitions['wanqjqmz']['Pizza_Place?order_receipt'] = ['tkmnmmzm'];
		transitions['iuthchrb'][''] = ['wanqjqmz'];
		transitions['xvmyrzmi']['Pizza_Place?Message_0rkgt7n'] = ['lgslqkpt'];
		transitions['mvjkbxnf'][''] = ['xogzupwz', 'xvmyrzmi'];
		transitions['xogzupwz']['Delivery_Boy?Message_1mi4idx'] = ['acxbqwvk'];
		transitions['fnmguihl']['Customer?Message_0i2a31h'] = ['akvbnhcq'];
		transitions['acxbqwvk'][''] = ['fnmguihl'];
		transitions['tkmnmmzm'][''] = ['mvjkbxnf'];
		transitions['lgslqkpt'][''] = ['pifktqjr'];
		transitions['akvbnhcq'][''] = ['pifktqjr'];
...
contract Enforcer {
	...
	function condition_receive_now(string memory message) private returns (bool){
		return nfa.checkEnabledTransitions(message);
	}
	
	
	function condition_receive_buffered() private returns (string memory){
		delete tmpStates;
	...
	function send(string memory message) private returns (string memory){
		return message;
	}
	
	
	function receive_now(string memory message) private returns (string memory){
		nfa.transition(message);
		return message;
	}
	
	
	function receive_delayed(string memory actor, string memory message) private returns (string memory){
		buffer_add(actor, message);
		return "";
	}
	
	
	function receive_buffered(string memory actor, string memory message) private returns (string memory){
